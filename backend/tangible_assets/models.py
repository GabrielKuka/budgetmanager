...
class Unit(models.Model):
    ...
    dimension = models.CharField(max_length=20, choices=DIMENSION_CHOICES, default='other')
    ...
    factor_to_base = models.DecimalField(max_digits=20, decimal_places=10, null=True, blank=True)
...
class PhysicalAsset(TangibleAsset):
    ...
    quantity   = models.DecimalField(max_digits=19, decimal_places=8, null=True, blank=True)
